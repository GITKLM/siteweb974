...
// }, { scope: container });
  ...
  return (
    ...
    <h1 className="hero__heading text-balance text-center text-5xl font-medium md:text-6xl max-w-5xl pt-14" style={{ lineHeight: '1.25' }}>
    ...
    <p className="hero__body italic text-xs sm:text-lg">Site vitrine, e-commerce ou sur-mesure <span className="bg-gradient-to-b from-yellow-100 to-yellow-500 bg-clip-text not-italic text-transparent font-bold">subventionné</span> par la Région</p>
    <div className=" hero__button flex sm:flex-row flex-col gap-4 items-center justify-center py-4">
    <ButtonRegion
    />
    <ButtonLink
    >Nous contacter</ButtonLink>
            ...
            <div>
            <div className='hero__image glass-container  sm:mt-12 mt-6'>
      ...
      >
        ...
        <p className="hero__phrase pt-11 text-center text-gray-400 text-xl italic">&quot;L&apos;Excellence Digitale à portée de clic&quot;</p>
            </div>
    </div>
  )
}
